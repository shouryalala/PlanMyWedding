    ...
    <div class="col-lg-4 img-wrapper">
        ...
        <a href="{{ 'gift/'.$data[$i]->product_no }}">
            <span style="position: absolute;margin-top: 2%;z-index: 89;margin-left: 75%;background-color: rgba(0,0,0,0.2)">
                ...
                <span style="font-size: 20px;color: white"><?php echo $data[$i]->product_rate;  ?></span>
            </span>
            <img class="img-responsive" src="{{ asset($data[$i]->product_img.'Image1.jpg') }}">
        </a>
